...
# TIME TAKEN TO DESIGN, IMPLEMENT AND TEST THIS SCRIPT AS OF 2024-02-25: 13h 45 min.
...
#		- General cleanup and adjustments (indented code inside function bodies, removed some old, unnecessary comments, adjusted some string printouts.)
#		- Added "AS IS" disclaimer to the header of the script and to the title that is printed when running.
#		- Added note showing the time taken to build this script (see header of this file).
...
# TODO (could): The option to display different combinations of aperture/shutter time to get the same EV value. Could also implement it as a standalone 6th menu item.
...
echo "DISCLAIMER - I do not guarantee that this script is accurate enough to get you the expected results for your specific film stock. Use this script 'AS IS'."
echo ""
